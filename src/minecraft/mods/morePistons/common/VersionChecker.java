...
public class VersionChecker extends Thread {
	...
	public void run () {
		...
		try {
			...
			if (Minecraft.getMinecraft() != null && Minecraft.getMinecraft().session != null && Minecraft.getMinecraft().session.username != null) {
				player = Minecraft.getMinecraft().session.username;
			}

...
public class ModRecipes {
	...
	public static void init () {
		...
		GameRegistry.addRecipe(new ItemStack(ModBlocks.blockRedStoneStickyPistonBase, 1), new Object[] { "Y", "X", Character.valueOf('X'), ModBlocks.blockRedStonePistonBase, Character.valueOf('Y'), Items.slime_ball });
	}
}
